<script>
  ...
  const slides = [
    {
      id: "one",
      text: "2 MONTHS AFTER 1 TX",
      subtext: "Actual patient results.",
      blurb: "Courtesy of Jason Pozner, MD",
      backgroundImage: "./assets/images/B&A-07.jpg",
      foregroundImage: "./assets/images/B&A-08.jpg",
    },
    {
      id: "two",
      ...
      backgroundImage: "./assets/images/B&A-01.jpg",
      foregroundImage: "./assets/images/B&A-02.jpg",
    },
    {
      id: "three",
      text: "AFTER 3 TX",
      ...
      backgroundImage: "./assets/images/B&A-09.jpg",
      foregroundImage: "./assets/images/B&A-10.jpg",
    },
  ];
</script>
